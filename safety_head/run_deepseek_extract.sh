...
$PY extract_features.py \
  ...
  --train_jsonl /path/to/safety_head_ckpts/mix_data/train_mix_deepseek70b.jsonl \
  --ood_jsonl  /path/to/safety_head_ckpts/mix_data/ood_eval_deepseek70b.jsonl \
  --out_path   /path/to/safety_head_ckpts/mix_data/features_deepseek70b.pt \
